...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { label: '7 Days cloud storage', included: true },
  ...
  },
  {
    ...
    stats: 'Up to 2,000 photos + videos',
    features: [
      { label: 'Everything in Free +', included: true },
      { label: '2,000 photo & video uploads', included: true },
      ...
      { label: '3 Months secure cloud storage', included: true },
  ...
  },
  {
    ...
    tagline: 'Unlimited memories with total moderation and custom branding.',
    stats: 'Unlimited photo & video uploads',
    features: [
      { label: 'Everything in Event +', included: true },
      { label: 'Unlimited photos & 4K video clips', included: true },
      ...
      { label: 'Extended 12 Months cloud storage', included: true },
  ...
  },
  {
    ...
    stats: 'Unlimited events & clients',
    features: [
      { label: 'Everything in Premium +', included: true },
      { label: 'Unlimited events & multi-client portal', included: true },
      ...
      { label: 'Priority 24/7 partner support', included: true },
    ],
  },
];
