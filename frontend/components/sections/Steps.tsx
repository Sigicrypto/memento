    ...
    <section id="howitworks" className="py-24 relative overflow-hidden scroll-mt-32">
      <div className="container">
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/2 left-0 w-full h-px bg-gradient-to-r from-transparent via-accent-cyan/15 to-transparent hidden lg:block" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            {[
              ...
              <motion.div
                ...
                className="viewfinder gcard gcard-accent group"
              >
                <Corners />
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-8">
                    <span className="font-mono-ui text-sm font-semibold text-accent-cyan tracking-widest">STEP {s.num}</span>
