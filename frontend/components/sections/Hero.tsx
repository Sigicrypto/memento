  ...
  return (
    <section className="relative overflow-hidden bg-bg min-h-screen flex flex-col items-center justify-center pt-32 pb-20 px-6 sm:px-12">
      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center text-center">
        ...
        >
          <div className="hero-badge mb-8 inline-flex backdrop-blur-md bg-surface/50 border-border">
            Live &middot; QR Photo Capture
          </div>
          ...
          <p className="text-lg lg:text-xl text-text-secondary mb-10 max-w-2xl leading-relaxed font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <button className="relative group inline-flex items-center justify-center px-6 py-3 font-medium text-text-secondary hover:text-text-primary transition-colors">
              ...
              <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-text-primary/20 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform origin-center" />
            </button>
          </div>
        </motion.div>
        ...
        >
          <div className="viewfinder card p-2 rounded-3xl overflow-hidden shadow-2xl bg-surface/70 backdrop-blur-xl border border-border">
            <Corners />
            <div className="h-12 border-b border-border flex items-center px-4 gap-3 bg-bg/50">
              <div className="flex items-center gap-1.5 text-accent-cyan">
                <ScanLine size={14} strokeWidth={2} />
                <span className="live-pulse" />
              </div>
              <div className="mx-auto w-48 sm:w-64 h-6 bg-surface border border-border rounded-md flex items-center justify-center shadow-sm">
                <span className="font-mono-ui text-[10px] text-text-secondary tracking-wide">memento.live/demo</span>
              </div>
              <span className="font-mono-ui text-[10px] text-accent-cyan tracking-wider hidden sm:inline font-bold">REC</span>
            </div>
            <div className="p-4 grid grid-cols-2 sm:grid-cols-4 gap-4 bg-bg/30">
              {[
                ...
                <div key={i} className="viewfinder aspect-[4/5] bg-surface border border-border rounded-xl overflow-hidden relative group transition-all duration-300 hover:border-border-hover shadow-md">
                   <Corners />
