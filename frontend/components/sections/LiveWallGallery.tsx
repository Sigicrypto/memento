...
import { Tv, Smartphone, Play, Zap } from "lucide-react";
  ...
  return (
    <section id="live-wall" className="w-full py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-slate-50/70 border-b border-slate-100 flex flex-col items-center justify-center">
      <div className="max-w-7xl w-full mx-auto flex flex-col items-center text-center">
        ...
        {/* Showcase Grid */}
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 text-left mb-10">
        ...
        {onOpenDemo && (
          <div className="w-full max-w-xl p-4 sm:p-5 rounded-2xl bg-[#0A2540] text-white flex flex-col sm:flex-row items-center justify-between gap-4 shadow-md">
