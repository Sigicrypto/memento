        ...
        {(isOpen || typeof window !== 'undefined' && window.innerWidth >= 768) && (
          <>
            ...
            <motion.aside
              ...
              className={`fixed md:sticky top-0 left-0 z-50 h-screen w-64 border-r border-white/10 dark:border-white/10 bg-surface/60 backdrop-blur-2xl flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}
            >
                    ...
                    <Link 
                      ...
                      className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl font-semibold text-sm transition-all duration-200 border ${
                        isActive 
                          ...
                          : 'hover:bg-white/5 text-text-secondary hover:text-text-primary border-transparent'
                      }`}
                    >
