...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:bottom-6 md:max-w-sm bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl p-5 shadow-[0_0_30px_rgba(0,0,0,0.5)] z-50 animate-in slide-in-from-bottom-5">
      ...
      <div className="flex gap-3">
        ...
        <button onClick={decline} className="flex-1 py-2.5 rounded-xl bg-white/5 border border-white/10 text-slate-300 text-xs font-bold hover:bg-white/10 hover:text-white transition-all">
          Decline Optional
        </button>
      </div>
    </div>
