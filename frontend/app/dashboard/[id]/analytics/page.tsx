  ...
  return (
    <div className="min-h-screen bg-black text-white p-8">
      ...
      <div className="flex justify-between items-end mb-10">
        ...
        <button className="flex items-center gap-2 px-6 py-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors text-sm font-bold">
      ...
      <div className="glass-panel p-8">
        ...
        <div className="h-64 flex items-end gap-2 sm:gap-4 border-b border-white/10 pb-4">
          {hourlyData.length === 0 ? (
