...
const PLAN_INFO: Record<string, { name: string; icon: string; color: string; glow: string; features: string[] }> = {
  starter: {
    ...
    features: ['Up to 150 guests', 'Live photo wall', '5 uploads/guest', 'Download as ZIP', '1 Month Storage'],
  },
  standard: {
    name: 'Standard',
    icon: '⭐',
    ...
    features: ['Up to 300 guests', 'Auto album creation', '15 uploads/guest', 'Slideshow TV Mode', '3 Months Storage'],
  },
  premium: {
    name: 'Premium',
    icon: '💎',
