            ...
            <div className="demo-modal-main relative">
               ...
               {photos.length === 0 ? (
                  <div className="demo-empty-state">
                     <span className="text-5xl mb-4 block">≡ƒô╖</span>
    ...
    <div className="lp pt-[calc(140px+env(safe-area-inset-top))]">
      <div className="flex flex-col gap-16">
        ...
        <div className="floating-shapes">
          <div className="shape s-cross s-1">Γ£ª</div>
          <div className="shape s-circle s-2" />
          <div className="shape s-star s-3">Γÿà</div>
          <div className="shape s-ring s-4" />
          <div className="shape s-cross s-5">Γ£ª</div>
        ...
        <section id="why" className="sec py-16">
          ...
          <div className="feat-grid">
            {[
              { icon: '≡ƒÄë', title: 'Perfect for Weddings', desc: 'From the first look to the last dance, every guest becomes your personal photographer.', big: true },
              { icon: '≡ƒÄé', title: 'Birthdays & Private Parties', desc: 'No more chasing friends for photos. Get them all at once in a beautiful live gallery.' },
              { icon: '≡ƒÅó', title: 'Corporate Events', desc: 'Level up your branding. Show real-time interaction on any screen with full moderation.' },
              { icon: '≡ƒæ░', title: 'Anniversaries', desc: 'Celebrate the journey. Let every generation share their memories in one click.' },
              { icon: '≡ƒÄê', title: 'Festivals', desc: 'Capture the scale and energy. Crowdsourced memories that look professional.' },
            ].map((f, i) => (
        ...
        <section id="features" className="sec py-16">
          ...
          <div className="feat-grid">
            {[
              { icon: '≡ƒô║', title: 'Live Slideshow', desc: 'Auto-plays on any screen. Cast to TV or projector for a stunning real-time display.', big: true },
              { icon: '≡ƒô╖', title: 'Polaroid Gallery', desc: 'Beautiful framed photos with captions and gentle float animations.' },
              { icon: '≡ƒöÆ', title: 'Private Walls', desc: 'Password-protect your wall. Approve photos before they go live.' },
              { icon: '≡ƒô▒', title: 'Mobile First', desc: 'Optimized for phones. Each guest gets their own personal photo page.' },
              { icon: 'ΓÜí', title: 'Real-time Sync', desc: 'Zero delay. Photos appear the instant they\'re uploaded.' },
              { icon: '≡ƒ¢í∩╕Å', title: 'Moderation', desc: 'Full control. Approve or remove any photo with one tap.' },
            ].map((f, i) => (
              <div key={i} className={`gcard feat-card ${f.big ? 'feat-big' : ''} reveal`} style={{ animationDelay: `${i * 0.08}s` }}>
                <div className="gcard-border" />
                <div className="gcard-inner">
        ...
        <section id="how" className="sec py-16">
          ...
          <div className="steps">
            {[
              { num: '01', icon: '≡ƒÄë', title: 'Create Your Event', desc: 'Name it and get a shareable QR code in under a minute.' },
              { num: '02', icon: '≡ƒô▓', title: 'Guests Scan & Share', desc: 'No app. No login. Just scan the QR and upload photos instantly.' },
              { num: '03', icon: 'Γ£¿', title: 'Watch It Come Alive', desc: 'Every photo streams live into a beautiful gallery for everyone.' },
            ].map((s, i) => (
        ...
        <section className="sec">
                ...
                <div className="gcard-inner">
                  <div className="flex gap-1 mb-3">
                    {[...Array(item.rating)].map((_, j) => (
                      <span key={j} className="text-amber-400">Γ¡É</span>
                    ))}
                  </div>
          ...
          <div className="social-proof-bar reveal">
            ...
            <div className="social-proof-item">
              <span className="text-2xl font-bold gradient-text">4.9Γÿà</span>
        ...
        <section id="pricing" className="sec py-16">
          <span className="kicker reveal">One-time Payment ΓÇó Per Event</span>
          ...
          {!showingINR && currency.showINR && (
            <button className="currency-toggle reveal" onClick={() => setShowingINR(!showingINR)}>
              Switch to {showingINR ? '$ USD' : 'Γé╣ INR'}
            </button>
          )}
            ...
            {[
              {
                ...
                features: [
                  'Γ£ô Collect guest photos instantly',
                  'Γ£ô Live photo wall',
                  'Γ£ô Unlimited uploads',
                  'Γ£ô Download all photos as ZIP',
                  '1 Month Storage'
                ],
              ...
              },
              {
                ...
                features: [
                  ...
                  '≡ƒÄÑ Auto album creation',
                  '≡ƒÄ¿ Custom wall theme',
                  '≡ƒôè Simple analytics',
                  '≡ƒô║ Slideshow TV Mode',
                  'Γ¥ñ∩╕Å Live reactions',
                  '3 Months Storage'
                ],
              ...
              },
              {
                ...
                features: [
                  ...
                  '≡ƒÄ╢ Music slideshow',
                  'ΓÅ│ Expiring galleries',
                  '≡ƒ¢í∩╕Å Priority support',
                  '≡ƒöÆ Advanced privacy options',
                  'Γÿü∩╕Å Google Drive sync',
                  '6 Months Storage'
                ],
              ...
              },
              {
                ...
                features: [
                  ...
                  '≡ƒöÑ Full branding removal',
                  '≡ƒîÉ Custom domain (e.g. photos.you.com)',
                  '≡ƒÆ░ Partner resell rights',
                  '≡ƒôè Client management',
                  '≡ƒÜÇ Training & Priority Setup'
                ],
              ...
              <div key={i} className={`gcard price-card ${p.popular ? 'popular' : ''} reveal`} style={{ animationDelay: `${i * 0.08}s` }}>
                <div className="gcard-border" />
                <div className="gcard-inner">
                  {p.popular && <span className="popular-tag">Γ¡É Most Popular</span>}
                  ...
                  <span className="price-period text-sm">per event ΓÇó one-time</span>
                  ...
                  <div className="mt-5 pt-4 border-t border-slate-200">
                    <p className="text-sm text-slate-500 italic">≡ƒÆ¼ {p.tagline}</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm border-collapse">
                ...
                <tbody className="text-slate-700">
                  {[
                    { f: 'Collect Photos', v: ['Γ£à', 'Γ£à', 'Γ£à', 'Γ£à'] },
                    { f: 'Live Wall', v: ['Γ£à', 'Γ£à', 'Γ£à', 'Γ£à'] },
                    { f: 'Auto Album', v: ['Γ¥î', 'Γ£à', 'Γ£à', 'Γ£à'] },
                    { f: 'Music Slideshow', v: ['Γ¥î', 'Γ¥î', 'Γ£à', 'Γ£à'] },
                    { f: 'Custom Domain', v: ['Γ¥î', 'Γ¥î', 'Γ¥î', 'Γ£à'] },
        ...
        <section className="cta-sec reveal py-12">
          ...
          <Link href="#pricing" className="btn-glow btn-lg">
            <span>Get Started Now ΓÇö {Sym}{Starter}</span>
        ...
        <footer className="lp-footer py-8">
          ...
          <div className="footer-bottom">
            <p>┬⌐ 2025 Memento. Made with ΓÖÑ for every celebration.</p>
          </div>
        </footer>
      </div>
