  ...
  return (
    <main className="lp min-h-screen relative overflow-hidden flex items-center justify-center px-4 py-24">
      ...
      <div className="w-full max-w-xl relative z-10">
        <div className="gcard cinematic-glow text-center backdrop-blur-xl border border-black/5 dark:border-black/20 dark:border-black/10 dark:border-white/5 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)]">
