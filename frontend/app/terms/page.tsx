      ...
      <div className="relative z-10 px-6">
        <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h1 className="text-4xl font-bold mb-2 text-white tracking-tight">Terms of Service</h1>
            ...
            <div className="gcard cinematic-glow">
              ...
              <div className="gcard-inner p-8 md:p-12 space-y-10">
                ...
                <section>
                  <h2 className="text-2xl font-semibold mb-4 text-white">4. Payment and Subscription</h2>
                  <div className="space-y-4 text-slate-300">
                ...
                <section>
                  <h2 className="text-2xl font-semibold mb-4 text-white">5. User Content and Conduct</h2>
                  <div className="space-y-4 text-slate-300">
                ...
                <section>
                  <h2 className="text-2xl font-semibold mb-4 text-white">7. Privacy</h2>
                  <div className="space-y-4 text-slate-300">
