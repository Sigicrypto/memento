    ...
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <div className="glass-panel p-8 md:p-10 space-y-8">
           ...
           <button onClick={() => signInWithGoogle()} className="w-full flex items-center justify-center gap-3 py-4 rounded-xl bg-bg-subtle border border-border hover:bg-border transition-all font-bold text-sm group">
           ...
           <form onSubmit={handleSubmit} className="space-y-5">
              {isSignUp && (
                 <div className="space-y-2">
                    ...
                    <div className="relative group">
                       ...
                       <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder="John Doe" className="w-full bg-bg-subtle border border-border rounded-xl pl-12 pr-4 py-3.5 focus:outline-none focus:border-primary transition-all text-sm" />
                    </div>
                 </div>
              )}
              ...
              <div className="space-y-2">
                 ...
                 <div className="relative group">
                    ...
                    <input type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="sarah@example.com" className="w-full bg-bg-subtle border border-border rounded-xl pl-12 pr-4 py-3.5 focus:outline-none focus:border-primary transition-all text-sm" />
                 </div>
              </div>
              ...
              <div className="space-y-2">
                 ...
                 <div className="relative group">
                    ...
                    <input type="password" value={password} onChange={e => setPassword(e.target.value)} required placeholder="••••••••" className="w-full bg-bg-subtle border border-border rounded-xl pl-12 pr-4 py-3.5 focus:outline-none focus:border-primary transition-all text-sm" />
                 </div>
              </div>
              ...
              {isSignUp && (
                 <div className="space-y-2">
                    ...
                    <div className="relative group">
                       ...
                       <input type="tel" value={phone} onChange={e => setPhone(e.target.value)} placeholder="+968 0000 0000" className="w-full bg-bg-subtle border border-border rounded-xl pl-12 pr-4 py-3.5 focus:outline-none focus:border-primary transition-all text-sm" />
                    </div>
                 </div>
              )}
