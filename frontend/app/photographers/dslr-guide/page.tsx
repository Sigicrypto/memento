...
export default function DSLRGuidePage() {
  return (
    <div className="min-h-screen bg-bg text-text-primary">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-32 pb-24 flex flex-col items-center text-center">
        {/* Breadcrumb */}
        ...
        <div className="rounded-2xl border border-border bg-surface p-6 sm:p-8 shadow-card mb-12 w-full flex flex-col items-center text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center w-full">
            <div className="p-4 rounded-xl bg-bg-subtle border border-border flex flex-col items-center text-center">
              <div className="w-8 h-8 rounded-lg bg-accent/10 text-accent flex items-center justify-center font-bold text-sm mb-2 mx-auto">
                1
              </div>
              <h3 className="font-bold text-sm text-text-primary mb-1 text-center">Shoot & Rate</h3>
              <p className="text-xs text-text-secondary text-center">Flag your best shots with in-camera 5-star ratings or lock button.</p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-bg-subtle border border-border flex flex-col items-center text-center">
              ...
              <p className="text-xs text-text-secondary text-center">Camera transfers selects via FTP / Wi-Fi to a folder or web uploader.</p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-bg-subtle border border-border flex flex-col items-center text-center">
              ...
              <p className="text-xs text-text-secondary text-center">Photos render in under 2s with your studio watermark or monogram.</p>
            </div>
          </div>
        </div>

        {/* Setup Methods */}
        <div className="space-y-8 mb-16 w-full text-center flex flex-col items-center">
          <h2 className="text-2xl font-bold text-text-primary font-display text-center">3 Battle-Tested Setup Methods</h2>
          ...
          <div className="rounded-2xl border border-border bg-surface p-6 sm:p-8 shadow-card w-full flex flex-col items-center text-center">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-4 text-center">
              <div className="w-10 h-10 rounded-xl bg-blue-500/10 text-blue-600 flex items-center justify-center mx-auto">
                <Laptop size={20} />
              </div>
              <div>
                <h3 className="text-lg font-bold text-text-primary text-center">Method A: Tethered Laptop + Auto-Upload</h3>
                <span className="text-xs text-text-muted text-center">Recommended for receptions, studio booths & key ceremonies</span>
              </div>
            </div>
            <p className="text-sm text-text-secondary leading-relaxed mb-4 text-center max-w-xl mx-auto">
            ...
            <ul className="space-y-2 text-xs text-text-secondary flex flex-col items-center">
          ...
          <div className="rounded-2xl border border-border bg-surface p-6 sm:p-8 shadow-card w-full flex flex-col items-center text-center">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-4 text-center">
              ...
              <div>
                <h3 className="text-lg font-bold text-text-primary text-center">Method B: Camera Wi-Fi / FTP Direct Transfer</h3>
                <span className="text-xs text-text-muted text-center">For Sony (A7 IV, A1), Canon (R5, R6), Nikon (Z8, Z9)</span>
              </div>
            </div>
            <p className="text-sm text-text-secondary leading-relaxed mb-4 text-center max-w-xl mx-auto">
        ...
        {/* CTA Box */}
        <div className="rounded-2xl border border-accent/30 bg-accent/5 p-8 text-center w-full">
          <h3 className="text-xl font-bold text-text-primary mb-2 font-display text-center">Need Custom Tethering Setup Assistance?</h3>
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-accent hover:bg-[#B8882F] text-white font-bold text-sm shadow-md transition-all cursor-pointer mx-auto"
          >
